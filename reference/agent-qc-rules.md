...
9. **运镜**：对照分镜表「运镜清单」逐条看首 / 中 / 末帧：推近是否绕主角、是否 30–45 帧 easeInOut（线性或 <15 帧记中）、运镜期间有没有 glitch 或错峰入场（记中）、HUD / 流程轨 / 字幕是否被带着动（记高）；一章少于 3 次运镜记低。
...
## 严重度
- 高：文字不可读/遮挡、整句无画面、事实错误、组件缺失（分镜表有而画面没有）、黑底盖星点、空场（主体 <80px 持续 >45 帧）、运镜带动 HUD / 字幕。
