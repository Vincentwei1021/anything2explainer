...
- **篇幅**（语速：`edge-tts en-US` +0% 实测 2.96 词/秒；加留白后成片密度 ≈ 2.3 词/秒。**kokoro speed 1.0 的实际语速尚未实测**——第一次做英文片时先跑一句看 `script/timeline.md` 的表头读数，再按它回调篇幅）：

  | 时长 | 英文词数 | 句 / 镜头数 | 章节 |
  |---|---|---|---|
  | 2–3 分钟 | 280–420 | 24–32 | 3 |
  | 3–5 分钟 | 420–700 | 40–50 | 4 |
  | 5–8 分钟 | 700–1150 | 60–80 | 5–6 |

- **每句 ≤20 词**（对应中文 ≤35 字），长句用 `|` 切成 2–5 块。
...
- 样片《RAG 与知识库》是中文片；英文片目前没有对标样片，**视觉标尺仍看 `examples/rag/frames/`**（图形语言与语言无关）。
