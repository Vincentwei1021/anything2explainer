 ...
 *   Noto Sans SC：小写 .566 大写 .668 数字 .590 空格 .227 半角标点 .325 汉字 1.000；русская кириллица берётся из таблицы точных ширин ниже
...
/** Noto Sans SC bundled-font advance widths for Russian Cyrillic, in em. */
const CYRILLIC_EM: Readonly<Record<string, number>> = {
  'Ё': .562, 'А': .574, 'Б': .621, 'В': .632, 'Г': .529, 'Д': .675,
  'Е': .562, 'Ж': .832, 'З': .602, 'И': .705, 'Й': .705, 'К': .603,
  'Л': .670, 'М': .770, 'Н': .698, 'О': .714, 'П': .694, 'Р': .598,
  'С': .619, 'Т': .573, 'У': .532, 'Ф': .779, 'Х': .519, 'Ц': .684,
  'Ч': .631, 'Ш': .913, 'Щ': .918, 'Ъ': .784, 'Ы': .832, 'Ь': .621,
  'Э': .619, 'Ю': .963, 'Я': .611,
  'а': .536, 'б': .584, 'в': .542, 'г': .434, 'д': .541, 'е': .527,
  'ж': .681, 'з': .485, 'и': .606, 'й': .606, 'к': .508, 'л': .548,
  'м': .674, 'н': .602, 'о': .586, 'п': .591, 'р': .595, 'с': .492,
  'т': .479, 'у': .468, 'ф': .770, 'х': .434, 'ц': .576, 'ч': .532,
  'ш': .780, 'щ': .773, 'ъ': .632, 'ы': .687, 'ь': .518, 'э': .492,
  'ю': .781, 'я': .540, 'ё': .527,
};
...
export const textEm = (s: string, emScale = 1): number => {
  ...
  for (const ch of s) {
    ...
    else if (CYRILLIC_EM[ch] !== undefined) em += CYRILLIC_EM[ch];
