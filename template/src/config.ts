...
export const VIDEO = {
  ...
  /**
   * 片子语言：'zh' 中文（默认）｜'en' 英文｜'ru' 俄文。
   * 影响 → 配音引擎与默认声音、标题/章节卡是否压窄、居中文字的基线补偿、文案与字幕块长度预算。
   */
  lang: 'zh' as 'zh' | 'en' | 'ru',
  /**
  ...
  /** 流程轨（可选，只给真有先后顺序步骤的章；一章最多一条，五步以内）：y118–162，当前步紫、已过灰底、未到灰边；有轨的章内容主区中文/英文 y175–620、俄文 y175–600。
