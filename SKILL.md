...
- 时长：落在确认点 1 用户要的区间内（差 >15% 就加/删句子，不要靠改语速凑）；语速中文约 6 字/秒、英文约 2.9 词/秒；成片比纯语音长 5–8% 是停留预算（段末 30 帧、段内 10 帧）。镜头按画面单元分：一段一个镜头，短句并入相邻镜头，单镜头 ≥120 帧。
